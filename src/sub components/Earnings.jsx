               ...
               <table className='w-full m-3'>
                   ...
                   <tbody>
                       <tr className='bg-white'>
                           ...
                           <td className='p-3 text-sm text-gray-700'>Eggs</td>
                           <td className='p-3 text-sm text-gray-700'>350</td>
                           <td className='p-3 text-sm text-gray-700'>Jimmy</td>
                           <td className='p-3 text-sm text-gray-700'>Teddy</td>
                           <td className='p-3 text-sm text-gray-100'><h4 className='bg-emerald-600 rounded-lg'>recieved</h4></td>
                       </tr>
                       ...
                       <tr className='bg-white'>
                           ...
                           <td className='p-3 text-sm text-gray-700'>Jimmy</td>
                           <td className='p-3 text-sm text-gray-700'>Teddy</td>
                           <td className='p-3 text-sm text-gray-700'><h4 className='bg-rose-400 rounded-lg'>Pending..</h4></td>
                       </tr>
                       <tr className='bg-gray'>
                           <td className='p-3 text-sm text-gray-700'>18-4-2020</td>
                           <td className='p-3 text-sm text-gray-700'>Eggs</td>
