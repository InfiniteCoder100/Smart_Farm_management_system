...
const Livestock = () => {
  return (
    <div className='w-full bg-emerald-300 md:bg-gray-300 text-center'>
         <Link to='/overview' className='bg-rose-400 rounded border-2 hover:bg-gray-100
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 flex flex-row items-start justify-start w-full'>
            <div className=' flex flex-col bg-gray-100 px-6 mx-6 my-3 shadow-lg shadow-gray-900'>
            ...
            <div className='bg-gray-100 my-3 mx-6 text-center rounded-xl shadow-lg shadow-gray-900'>
                    <h1 className='text-xl md:font-black text-2xl'>
                        Animal Bio
                    </h1>
                <div className=' bg-gray-900 text-white rounded-lg grid grid-cols-2 gap-5 '>
                ...
                <div className='bg-gray-300 rounded-xl text-white text-center py-6 items-center justify-center'>
